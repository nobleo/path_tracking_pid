...
class TestPathTrackingPID(unittest.TestCase):
    ...
    def test_exepath_action(self):
        ...
        (x_circ, y_circ, yaw_circ) = points_on_circle(linspace(-0.5*pi, 0.5*pi, num=1000), radius=5.0, center=(0.0, 4.0))
        ...
        reconfigure.update_configuration({"la": 0.0})
